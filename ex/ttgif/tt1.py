# this code converts the animation to webp which you wanted to do initally , but capturing animation is a pain , abandon , and instead use an image recorder to make gif
